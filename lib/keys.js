...
export const MEMBER_JOB_TYPES = ['evaluate', 'scan', 'pdf', 'cover', 'sync_setup', 'deep', 'advise', 'contacto', 'apply', 'apply_form', 'apply_fill', 'interview_prep', 'followup', 'patterns'];
export const ADMIN_JOB_TYPES = ['import_model', 'build_dataset', 'generate_gold', 'finetune', 'exam', 'promote'];
export const AGENT_KEYS = ['scout', 'extractor', 'evaluator', 'tailor', 'writer', 'researcher'];
