...
export const DEFAULT_AGENTS_CONFIG = {
  agents: {
    ...
    researcher:{ model: 'claude-cli', numCtx: 8192, numPredict: 2200, temperature: 0.3, systemPrompt: RESEARCHER_SYSTEM_PROMPT, promptVersion: 1, enabled: true, n8nWorkflowId: null },
  },
  dailyEvalQuota: 20,
  dailyScanQuota: 6,      // Scout runs per member per day (zero tokens, but a browser pass can take minutes per site)
